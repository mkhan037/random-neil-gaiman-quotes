// Required:
// 1. Create an array of objects named quotes & make it accessible in the global scope
// 2. Give each object the following properties:
//    a. quote property that contains the string of the quote
//    b. source property that is a string of who said the quote (if known)
//    c. OPTIONAL: citation property that contains the string of where the quote came from (re: a speech, book, etc)
//    d. OPTIONAL: year property that contains a number of the date of the quote (if known)
// Additionally:
